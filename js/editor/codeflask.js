! function(e, t) {
    ...
    "use strict";
    var e, t, n, a = '"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace',
    ...
    var c, u = (function(e) {
            var t = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
                n = function() {
                    var e = /\blang(?:uage)?-([\w-]+)\b/i,
                        ...
                        a = t.Prism = {
                                ...
                                clone: function(e, t) {
                                    ...
                                    switch (t = t || {}, n) {
                                        case "Object":
                                            ...
                                            var s = {};
                                            for (var i in t[a.util.objId(e)] = s, e) e.hasOwnProperty(i) && (s[i] = a.util.clone(e[i], t));
                                            return s;
                                        case "Array":
                                            if (t[a.util.objId(e)]) return t[a.util.objId(e)];
                                            s = [];
                            ...
                            languages: {
                                ...
                                insertBefore: function(e, t, n, s) {
                                    ...
                                    if (2 == arguments.length) {
                                        for (var r in n = arguments[1]) n.hasOwnProperty(r) && (i[r] = n[r]);
                                        return i
                                    }
                                    var o = {};
                                    for (var l in i)
                                ...
                                DFS: function(e, t, n, s) {
                                    for (var i in s = s || {}, e) e.hasOwnProperty(i) && (t.call(e, i, e[i], n || i), "Object" !== a.util.type(e[i]) || s[a.util.objId(e[i])] ? "Array" !== a.util.type(e[i]) || s[a.util.objId(e[i])] || (s[a.util.objId(e[i])] = !0, a.languages.DFS(e[i], t, i, s)) : (s[a.util.objId(e[i])] = !0, a.languages.DFS(e[i], t, null, s)))
                                }
                            },
                            plugins: {},
                            ...
                            highlightElement: function(n, s, i) {
                                ...
                                l && (r = (l.className.match(e) || [, ""])[1].toLowerCase(), o = a.languages[r]), n.className = n.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r, n.parentNode && (l = n.parentNode, /pre/i.test(l.nodeName) && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r));
                                var c = {
                                    element: n,
                                    language: r,
                                    grammar: o,
                            ...
                            matchGrammar: function(e, t, n, s, i, r, o) {
                                var l = a.Token;
                                for (var c in n)
                                    if (n.hasOwnProperty(c) && n[c]) {
                                        ...
                                        for (var d = 0; d < u.length; ++d) {
                                            ...
                                            h = h.pattern || h;
                                            for (var k = s, v = i; k < t.length; v += t[k].length, ++k) {
                                                var x = t[k];
                                                if (t.length > e.length) return;
                                                if (!(x instanceof l)) {
                                                    if (f && k != t.length - 1) {
                                                        if (h.lastIndex = v, !(L = h.exec(e))) break;
                                                        for (var w = L.index + (g ? L[1].length : 0), C = L.index + L[0].length, S = k, T = v, A = t.length; S < A && (T < C || !t[S].type && !t[S - 1].greedy); ++S) w >= (T += t[S].length) && (++k, v = T);
                                                    ...
                                                    if (L) {
                                                        ...
                                                        var j = new l(c, p ? a.tokenize(L, p) : L, b, L, f);
                                                        if (N.push(j), _ && N.push(_), Array.prototype.splice.apply(t, N), 1 != F && a.matchGrammar(e, t, n, k, v, !0, c), r) break
                                                    } else if (r) break
                                                }
                                            }
                                        }
                    ...
                    if (s.stringify = function(e, t, n) {
                            ...
                            if (e.alias) {
                                var r = "Array" === a.util.type(e.alias) ? e.alias : [e.alias];
                        ...
                        var n = JSON.parse(e.data),
                            ...
                            i = n.code,
                            r = n.immediateClose;
                        t.postMessage(a.highlight(i, a.languages[s], s)), r && t.close()
                    }, !1), t.Prism) : t.Prism;
            ...
            e.exports && (e.exports = n), void 0 !== l && (l.Prism = n), n.languages.markup = {
                ...
                Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function(t) {
                    for (var a, s = t.getAttribute("data-src"), i = t, r = /\blang(?:uage)?-([\w-]+)\b/i; i && !r.test(i.className);) i = i.parentNode;
    ...
    return d.prototype.startEditor = function() {
        ...
        for (var e = "", t = 0; t <= this.lineNumber; t++) e = e + '<span class="codeflask__lines__line">' + t + "</span>";
        ...
        if (this.opts.handleTabs) {
            ...
            if (a !== s && o.length >= c.length) {
                var u = a - r.split("\n").pop().length,
                    d = c.length,
                    h = c.length;
                if (e.shiftKey) i.substr(u, c.length) === c ? (d = -d, u > a ? (o = o.substring(0, u) + o.substring(u + c.length), h = 0) : u === a ? (d = 0, h = 0, o = o.substring(c.length)) : (h = -h, r = r.substring(0, u) + r.substring(u + c.length))) : (d = 0, h = 0), o = o.replace(new RegExp("\n" + c.split("").join("\\"), "g"), "\n");
                else r = r.substr(0, u) + c + r.substring(u, a), o = o.replace(/\n/g, "\n" + c);
                t.value = r + o + l, t.selectionStart = a + d, t.selectionEnd = a + o.length + h, t.selectionDirection = n
        ...
        this.lineNumber = this.code.split("\n").length - 1, this.opts.lineNumbers && this.updateLineNumbersCount()
